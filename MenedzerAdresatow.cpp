...
void MenedzerAdresatow::wyszukajAdresatowPoImieniu()
{
...
void MenedzerAdresatow::wyszukajAdresatowPoNazwisku()
{
...
void MenedzerAdresatow::wyswietlIloscWyszukanychAdresatow(int iloscAdresatow)
{
    if (iloscAdresatow == 0)
...
void MenedzerAdresatow::edytujAdresata()
{
    system("cls");
    Adresat adresat;
...
char MenedzerAdresatow::wybierzOpcjeZMenuEdycja()
{
    char wybor;
...
void MenedzerAdresatow::zaktualizujDaneWybranegoAdresata(Adresat adresat)
{
